...
def main():
    ...
    for mod in ["security", "sandbox", "goals", "browser", "computer_use", "project", "versioning", "selfupgrade", "selfcode", "config", "brain", "knowledge", "learner", "skills", "skills_extra", "agent", "pc", "builder",
